...
public class ServicePaperTest {
    ...
    public void testSavePaper (){
        setUp();
        Paper paper=new Paper(12,"Los tamales de maria","Los tamales de maria son los mejores","No se",user,conference);
    ...
    public void testDelatePaper(){
        setUp();
        Paper paper=new Paper(0,"Los tamales de maria","Los tamales de maria son los mejores","No se",user,conference);
        service.storePaper(paper);
    ...
    public void testEditPaper(){
        setUp();
        Paper paper1=new Paper(0,"Los tamales de maria","Los tamales de maria son los mejores","No se",user,conference);
        Paper paper2=new Paper(0,"Los grandes tamales de maria","Los tamales grandes son los mejores","No se",user,conference);
    ...
    public void testPapersAuthor(){
        setUp();
        Paper paper1=new Paper(12,"Los tamales de maria","Los tamales de maria son los mejores","No se",user,conference);
        Paper paper2=new Paper(12,"Los almuerzos de Juan","Juan cocina las mejores Papitas","No se",user,conference);
        service.storePaper(paper1);
